(module
  ;; Real FFT using Radix-4 for improved performance at power-of-4 sizes
  ;;
  ;; Algorithm: Same as fft_real.wat but uses radix-4 complex FFT
  ;; For N real inputs where N/2 is a power of 4 (N=8, 32, 128, 512, 2048, 8192)
  ;;
  ;; Memory layout:
  ;;   0 - 65535:        Primary buffer
  ;;   65536 - 131071:   Secondary buffer (ping-pong)
  ;;   131072 - 196607:  Complex FFT twiddles
  ;;   196608+:          Post-processing twiddles
  ...
  (func $fft_16
    ...
    ;; Group 1: x4,x5,x6,x7 with W_16^1,2,3
    ...
    ;; Group 2: x8,x9,x10,x11 with W_16^2,4,6
    ...
    ;; Group 3: x12,x13,x14,x15 with W_16^3,6,9
  ...
  ;; General radix-4 FFT (copied from fft_radix4.wat for self-containment)
  ...
  ;; Precompute twiddles for real FFT
  ...
  ;; Real FFT using radix-4 complex FFT
  (func $rfft (export "rfft") (param $n i32)
    ...
    ;; Run N/2-point radix-4 FFT
    (call $fft_radix4 (local.get $n2))

    ;; Post-processing (same as fft_real.wat)
