(module
  ...
  (func $rfft_postprocess_64
    ...
    ;; W_rot for k=31,30
    (local.set $wn2k_rot (v128.const f32x4 -0.0980171412229538 0.9951847195625305 -0.19509032368659973 0.9807852506637573))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.290284663438797 0.9569403529167175 -0.3826834261417389 0.9238795042037964))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.4713967442512512 0.8819212913513184 -0.5555702447891235 0.8314695954322815))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.6343932747840881 0.7730104327201843 -0.7071067690849304 0.7071067690849304))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.7730104327201843 0.6343932747840881 -0.8314695954322815 0.5555702447891235))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.8819212913513184 0.4713967442512512 -0.9238795042037964 0.3826834261417389))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.9569403529167175 0.290284663438797 -0.9807852506637573 0.19509032368659973))
    (local.set $wr (i8x16.shuffle 0 1 2 3 0 1 2 3 8 9 10 11 8 9 10 11 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $wi (i8x16.shuffle 4 5 6 7 4 5 6 7 12 13 14 15 12 13 14 15 (local.get $wn2k_rot) (local.get $wn2k_rot)))
    (local.set $prod (f32x4.mul (local.get $diff2) (local.get $wr)))
    (local.set $swapped (i8x16.shuffle 4 5 6 7 0 1 2 3 12 13 14 15 8 9 10 11 (local.get $diff2) (local.get $diff2)))
    ...
    (local.set $sum2 (f32x4.add (local.get $zn2k) (local.get $conj_zk)))
    (local.set $diff2 (f32x4.sub (local.get $zn2k) (local.get $conj_zk)))
    (local.set $wn2k_rot (v128.const f32x4 -0.9951847195625305 0.0980171412229538 0 0))
